...
public class SetNewPasswordForLoggedInUserActivity extends AbstractActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_set_new_password_for_logged_in_user_new);
        appController = AppController.getController(this);
        boolean flag  = appController.askForChangePassword();
        if (!flag)
            showAlertAndGoBackHome(R.string.something_went_wrong_please_log_in);
    }
    ...
    public void setNewPassword(View view) {
        ...
        if (valid_msg.equals("OK")) {
            ...
            if (!flag) {
                ...
                showInfo(R.string.password_has_changed2);
            }
        }
        else {
    ...
    private void showAlert(int msg) {
        new AlertDialog.Builder(SetNewPasswordForLoggedInUserActivity.this)
    ...
    private void showAlertAndGoBackHome(int msg) {
        new AlertDialog.Builder(SetNewPasswordForLoggedInUserActivity.this)
                .setTitle(R.string.error)
                .setMessage(msg)
